        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
            <div>
                <h1
                    ...
                    Purchase Request Management</h1>
                <p class="mt-1 text-gray-500 dark:text-gray-400"> Streamline your procurement process with our Purchase
                    Request System.</p>
                <div class="mt-4 flex flex-wrap items-center gap-4">
                    ...
                    <div class="flex items-center transition transform hover:scale-110">
                        ...
                        <span class="text-sm font-medium text-gray-600 dark:text-gray-300">Price Updated/PR
                            Printed/Waiting Quotation</span>
                    </div>
                    <div class="flex items-center transition transform hover:scale-110">
                    ...
                    <div class="flex items-center transition transform hover:scale-110">
                        ...
                        <span class="text-sm font-medium text-gray-600 dark:text-gray-300">HQ 1 Denied/HQ 2 Denied/HQ 3
                            Denied/Canceled</span>
                    </div>
                </div>
