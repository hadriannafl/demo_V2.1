                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($ajus as $index => $aju)
                            <tr class="hover:bg-gray-100 odd:bg-gray-100 even:bg-white">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $aju->tipe_docs }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $aju->no_docs }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                ...
                                <td
                                    ...
                                    <button
                                        ...
                                        type="button"
                                        onclick="openPdfInNewTab('{{ $aju->pdf_jpg ?? '' }}')">View</button>
                                    <div x-data="modal({{ $aju }})">
                                        <button
                                            ...
                                            <div class="bg-white rounded shadow-lg overflow-auto w-3/4 max-h-full"
                                                ...
                                                <div class="px-5 py-3 border-b border-slate-200" id="modalAddLpjDetail">
                                                    <div class="flex justify-between items-center">
                                                        <div class="font-semibold text-slate-800">Edit AJU</div>
                                                        <button type="button"
                                                ...
                                                <div class="modal-content text-xs px-5 py-4">
                                                    <form method="POST"
                                                        action="{{ route('indexAju.update', $aju->id_aju) }}"
                                                        ...
                                                        <div class="grid md:grid-cols-2 md:gap-6">
                                                            ...
                                                            <div class="relative z-0 w-full mb-5 group">
                                                                <input type="date" name="date" id="date"
                                                                    ...
                                                                    value="{{ old('date', $aju->date) }}" required />
                                                                <label for="date"
                                                        ...
                                                        <div class="grid md:grid-cols-3 md:gap-6 mb-5">
                                                            <div class="relative z-0 w-full group">
                                                                <select name="dep" id="dep"
                                                                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                                                    required>
                                                                    <option value="" disabled>Select Department
                                                                    </option>
                                                                    @foreach ($deps as $department)
                                                                        <option value="{{ $department->id }}"
                                                                            {{ old('dep', $aju->department_id) == $department->id ? 'selected' : '' }}>
                                                            ...
                                                            <div class="relative z-0 w-full group">
                                                                <select name="sub_dep" id="sub_dep"
                                                                    ...
                                                                    <option value="" disabled>Select Sub
                                                                        Department</option>
                                                                    @foreach ($aju->department->subDepartments as $subDepartment)
                                                                        <option value="{{ $subDepartment->id }}"
                                                                            {{ old('sub_dep', $aju->sub_department_id) == $subDepartment->id ? 'selected' : '' }}>
                                                            ...
                                                            <div class="relative z-0 w-full mb-5 group">
                                                                <select name="type_docs_modal" id="type_docs_modal"
                                                                    ...
                                                                    <option value="Invoice" data-code="INV"
                                                                        {{ old('type_docs_modal', $aju->tipe_docs) == 'Invoice' ? 'selected' : '' }}>
                                                                        Invoice</option>
                                                                    <option value="Purchase Order" data-code="PO"
                                                                        {{ old('type_docs_modal', $aju->tipe_docs) == 'Purchase Order' ? 'selected' : '' }}>
                                                                        Purchase Order</option>
                                                                    <option value="Delivery Order" data-code="DO"
                                                                        {{ old('type_docs_modal', $aju->tipe_docs) == 'Delivery Order' ? 'selected' : '' }}>
                                                                        Delivery Order</option>
                                                                    <option value="Contract" data-code="CTR"
                                                                        {{ old('type_docs_modal', $aju->tipe_docs) == 'Contract' ? 'selected' : '' }}>
                                                                        Contract</option>
                                                                    <option value="Proposal" data-code="PRP"
                                                                        {{ old('type_docs_modal', $aju->tipe_docs) == 'Proposal' ? 'selected' : '' }}>
                                                                        Proposal</option>
                                                                    <option value="Report" data-code="RPT"
                                                                        {{ old('type_docs_modal', $aju->tipe_docs) == 'Report' ? 'selected' : '' }}>
                                                                        Report</option>
                                                                    <option value="Memo" data-code="MMO"
                                                                        {{ old('type_docs_modal', $aju->tipe_docs) == 'Memo' ? 'selected' : '' }}>
                                                                        Memo</option>
                                                                    <option value="Agreement" data-code="AGR"
                                                                        {{ old('type_docs_modal', $aju->tipe_docs) == 'Agreement' ? 'selected' : '' }}>
                                                                        Agreement</option>
                                                                    <option value="Receipt" data-code="RCT"
                                                                        {{ old('type_docs_modal', $aju->tipe_docs) == 'Receipt' ? 'selected' : '' }}>
                                                                        Receipt</option>
                                                                    <option value="Manual Guide" data-code="MGD"
                                                                        {{ old('type_docs_modal', $aju->tipe_docs) == 'Manual Guide' ? 'selected' : '' }}>
                                                                        Manual Guide</option>
                                                                    <option value="Policy Document" data-code="PLD"
                                                                        {{ old('type_docs_modal', $aju->tipe_docs) == 'Policy Document' ? 'selected' : '' }}>
                                                                        Policy Document</option>
                                                                    <option value="Technical Specification"
                                                                        data-code="TSP"
                                                                        {{ old('type_docs_modal', $aju->tipe_docs) == 'Technical Specification' ? 'selected' : '' }}>
                                                                        Technical Specification</option>
                                                                    <option value="Meeting Minutes" data-code="MMT"
                                                                        {{ old('type_docs_modal', $aju->tipe_docs) == 'Meeting Minutes' ? 'selected' : '' }}>
                                                                        Meeting Minutes</option>
                                                                    <option value="Certification" data-code="CRT"
                                                                        {{ old('type_docs_modal', $aju->tipe_docs) == 'Certification' ? 'selected' : '' }}>
                                                                        Certification</option>
                                                                    <option value="Legal Document" data-code="LGD"
                                                                        {{ old('type_docs_modal', $aju->tipe_docs) == 'Legal Document' ? 'selected' : '' }}>
                                                        ...
                                                        <div class="flex items-center space-x-2 w-full mb-5">
                                                            <div class="relative z-0 w-full group">
                                                                <input name="description" id="description"
                                                                    autocomplete="off"
                                                                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                                                    value="{{ old('description', $aju->description) }}"
                                                                    required />
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('modal', (document) => ({
                ...
                fileUploaded: false,
                document: document,
                fileNames: document.pdf_jpg ? [document.file_name] : [],
