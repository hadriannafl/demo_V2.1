<x-app-layout>
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            <input type="date" name="date" id="date" autocomplete="off"
                                ...
                                value="{{ isset($aju->date) ? $aju->date : '' }}" required />
                            <label for="date"
                        ...
                        <div class="relative z-0 w-full mb-5 flex items-center space-x-2">
                            <div class="w-full">
                                <input name="id_aju" id="id_aju" autocomplete="off"
                                    ...
                                    placeholder=" " @if (!empty($aju)) disabled @endif required />
                                <label for="id_aju"
                                    class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
                                    AJU Number
                                </label>
    ...
    <script>
        ...
        document.getElementById('ajuForm').addEventListener('submit', function(event) {
            ...
            Swal.fire({
                title: "Are you sure?",
                text: "Once updated, data cannot be changed!",
                icon: "warning",
                ...
                if (result.isConfirmed) {
                    ...
                    // Menambahkan metode PUT ke FormData
                    formData.append('_method', 'PUT');

                    fetch(form.action, {
                            method: 'POST', // Laravel menerima _method=PUT
                            body: formData,
                            headers: {
                        ...
                        .then(data => {
                            if (data.status === 'success') {
                                ...
                                // Menonaktifkan input setelah update
