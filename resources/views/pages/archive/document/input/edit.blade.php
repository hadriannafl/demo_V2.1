<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        <div class="flex items-center justify-between">
            <h2 class="text-3xl font-semibold">AJU Document Editing Management</h2>
        </div>
                                            ...
                                            <div id="feedback-modal1"
                                                ...
                                                <div class="bg-white rounded shadow-lg overflow-auto w-3/4 max-h-full"
                                                    ...
                                                    <div class="modal-content text-xs px-5 py-4">
                                                        <form method="POST" action="{{ route('index.Update', $index->idrec) }}"
                                                            enctype="multipart/form-data">
                                                            @csrf
                                                            @method('PUT')
                                                            <input type="hidden" name="id" id="id" value="{{ $index->idrec }}">
                                                            <input type="hidden" name="id_aju" id="id_aju"
                                                                value="{{ $ajuDocs->id_aju }}">
                                                            <div class="grid md:grid-cols-2 md:gap-6">
                                                                ...
                                                                <div class="relative z-0 w-full mb-5 group">
                                                                    <input type="date" name="date" id="date"
                                                                        ...
                                                                        required x-model="document.date" />
                                                                    <label for="date"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="w-full">
                                                                        <input name="no_archive" id="no_archive"
                                                                            autocomplete="off"
                                                                            ...
                                                                            placeholder=" " required x-model="document.no_archive" />
            ...
            Alpine.data('modal', (document) => ({
                ...
                init() {
                    if (this.fileNames.length > 0) {
                        this.files = this.fileNames.map(name => ({ name }));
