<x-app-layout>
                                            ...
                                            <div class="bg-white rounded shadow-lg overflow-auto w-3/4 max-h-full"
                                                ...
                                                <div class="px-5 py-3 border-b border-slate-200" id="modalAddLpjDetail">
                                                    <div class="flex justify-between items-center">
                                                        <div class="font-semibold text-slate-800">Edit Document Type
                                                        </div>
                                                        <button type="button"
                                                        ...
                                                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                                            ...
                                                            <div>
                                                                ...
                                                                <input type="text" name="code" id="code"
                                                                    x-model="formData.code" autocomplete="off"
                                                            ...
                                                            <div>
                                                                ...
                                                                <input type="text" name="name" id="name"
                                                                    x-model="formData.name" autocomplete="off"
                                                                    class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                                                    required>
                                                            </div>
    ...
    @endif
    <script>
        function modal(documentType = null) {
            return {
                ...
                formData: {
                    ...
                    status: documentType?.status ? '1' : '0'
                },
                init() {
                    if (documentType) {
                        this.formData = {
